...
const char* ssid     = "Robotic arm"; //change as per your requirement
const char* password = "123456789"; //change as per your requirement
...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <h1 style="color: teal;text-align:center;">ROBUKITS</h1>
